...
public:
	...
	std::vector<Wall> doorsWall = {
		{Point(152.284,11.0674,-215.416),Point(156.09,34.7261,-200.588)},//الباب تبع المطعم 
	};
	...
	std::vector<Wall> walls = {
		...
		//{Point(9.3216,62.6662,-291.197),Point(32.4679,87.4415,-281.114)},//الباب العلوي للمصعد 
